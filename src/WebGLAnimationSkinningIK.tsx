...
const init3D = (container: HTMLElement) => {
    ...
    const conf = { followSphere: false, turnHead: true, ik_solver: true, update: () => {} }

    const updateIK = () => {
        if (IKSolver) IKSolver.update()
        scene.traverse((object: any) => { if (object.isSkinnedMesh) object.computeBoundingSphere() })
    }
    conf.update = updateIK
...
export default function WebGLAnimationSkinningIK() {
