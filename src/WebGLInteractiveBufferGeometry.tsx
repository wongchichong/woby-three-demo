...
const init3D = (container: HTMLElement) => {
  ...
  // Camera
  const camera = new THREE.PerspectiveCamera(27, container.clientWidth / container.clientHeight, 1, 3500)
  ...
  // Line for highlighting intersected triangle
...
export default function WebGLInteractiveBufferGeometry() {
